...
Dynamic params in Next.js 16 are async (same as 15):
...
Always TypeScript. Key types to know:
...
When the user mentions deploying to Vercel:
...
**Useful defaults Vercel handles automatically:**
